...
<head>
    ...
    <link rel="stylesheet" type="text/css" href={{ asset('cms/assets/css/color-1.css') }} media="screen">
    <!-- Responsive css-->
...
<body>
    ...
    <div class="container-fluid p-0">
                ...
                <div class="login-card">
                    <div>
                        <div><a class="logo" href="index.html"><img class="img-fluid for-light"
                                    src={{ asset('cms/assets/images/logo/login.png') }} alt="loginpage"><img
                                    class="img-fluid for-dark" src={{ asset('cms/assets/images/logo/logo_dark.png') }}
        ...
        <!-- feather icon js-->
        <script src={{ asset('cms/assets/js/icons/feather-icon/feather.min.js') }}></script>
        <script src={{ asset('cms/assets/js/icons/feather-icon/feather-icon.js') }}></script>
        <!-- scrollbar js-->
        <!-- Sidebar jquery-->
